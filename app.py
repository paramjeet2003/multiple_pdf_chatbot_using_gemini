...
def get_conversational_chain():
    ...
    context, make sure to provide all the details, if the answer is 
    not in provided context, just say, "answer is not available in the
...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        api_key = st.text_input("Enter the Google API key: ", type='password')
        if api_key:
